    ...
    <div>
      ...
      <div className="flex flex-col gap-2 m-8">
        ...
        <div className="w-full flex justify-center md:justify-start ">
          <button className="bg-red-500 text-white w-full py-2 rounded-md md:w-[30%] cursor-pointer">
            Se déconnecter
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 m-8">
        ...
        <div className="w-full flex justify-center md:justify-start">
          <button className="bg-white w-full py-2 px-4 rounded-md text-start flex justify-between items-center md:w-[30%] cursor-pointer">
            <span className="bg-gradient-to-r from-dark-bg to-accent bg-clip-text text-transparent ">
              Thème néon
            </span>{" "}
            <IoIosArrowDown className="text-dark-bg" />
          </button>
        </div>
      </div>
      <div className="flex justify-center items-center">
      ...
      <div className="flex flex-col gap-2 m-8">
        ...
        <div className="w-full flex justify-center md:justify-start">
          <button className="bg-red-500 text-white w-full py-2 px-4 rounded-md text-start flex justify-between items-center tracking-wide md:w-[30%] cursor-pointer">
